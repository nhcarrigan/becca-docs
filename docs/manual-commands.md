...
| `feedback`    | `null`       | Provides a modal that allows you to send feedback to our team. The feedback you send, your avatar and user tag, and your server name will be included. This is posted in our support server so our community can discuss. |
